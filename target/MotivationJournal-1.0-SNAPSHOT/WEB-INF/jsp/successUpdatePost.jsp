...
<html>
    <head>
        <title>Update Post Success Page</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <h1 align="center"><strong>You have updated a post successfully!</strong></h1>
        <h2 align="center" style="color:Gray">Here is the updated post: </h2>
                ...
                <td>
                    <div align="center">
                        <table id="table2" border="0" cellpadding="5" cellspacing="0">
                            <tr>
                                <td><strong style="font-size:20px;">${updated_post.user.name} </strong></td>
                            </tr>
                            <tr>
                                <td><small>${updated_post.createTime}</small></td>
                            </tr>
                            <tr>
                                <td><div style="font-size:20px;">${updated_post.text}</div></td>
                            </tr>
                ...
                <td>
                    <div align="center">
                        <table id="table2" border="0" cellpadding="5" cellspacing="0">
                            ...
                            <tr>
                                <c:forEach var="image" items="${updated_post.images}">
