...
<html>
    ...
    <body>
        ...
        <h1 align="center"><strong>Register account</strong></h1>
        <h2 align="center" style="color:Gray">Create a new account</h2>
        ...
        <div style="width:100%;text-align:center">
            <form:form modelAttribute="user">
                ...
                <form:hidden path="isBanned" value="false"/>
                <input type="submit" value="Register" />
            </form:form>
        </div>   
        <div style="width:100%;text-align:center">
            <br />
            <a href="login.htm">Already have an account? Sign In</a>
        </div>
    </body>
</html>
